...
q2reg3 = glm(positive_sal78 ~ age.c + re74 + re75 + as.factor(employed_74) + as.factor(employed_75) + as.factor(black) + as.factor(hispan) + as.factor(married) + as.factor(nodegree) + as.factor(treat), data = ldata, family = binomial)
